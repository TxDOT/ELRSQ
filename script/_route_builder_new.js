...
function addProjectToArray(myProjects) {
    ...
    const RTE_NM = document.getElementById('p_returned_RTE_DEFN_LN_NM').innerHTML;
    const BDFO = document.getElementById('p_returned_RTE_DFO_begin').innerHTML;
    const EDFO = document.getElementById('p_returned_RTE_DFO_end').innerHTML;
